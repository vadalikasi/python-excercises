...
# Python 3.7 and later requires the "try:... except StopIeration: return"
# idiom, due to PEP 479 (https://www.python.org/dev/peps/pep-0479/).
# In 3.6 and earlier, you can let the call to next() simply raise
