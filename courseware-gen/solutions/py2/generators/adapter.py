...
# human-readable text files. (For a more scalable version, which can
# handle a 10 TB text file consisting of exactly one line, see the
# python3 solution of this lab.)
